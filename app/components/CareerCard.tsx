...
export default function CareerCard({ title, subtitles }: CareerCardProps) {
  return (
    <div className="w-[320px] sm:w-[420px] md:w-[580px] rounded-lg bg-gray-100 px-12 py-16 shadow-[0_.25rem_.5rem_-0.25rem_#0003,0_1rem_1.5rem_-1rem_#0003,0_1.5rem_2.5rem_-1.5rem_#0003,0_2.5rem_5rem_-2.5rem_#0003]">
